...
@section('content')
    <section class="content-header">
        <h1>
            Controle Site Messages
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{ url('/adminpanel') }}"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active"><a href="{{ url('/users') }}">Controle Site Messages</a></li>
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Controle Site Messages</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
    ...
    <script type="text/javascript">
        ...
        $('#data thead th').each( function () {
            if($(this).index()  < 4 ){
                ...
                $(this).html( '<select><option value="0"> New Message </option>' +
                    '<option value="1"> Old Message </option>' +
                    '' +
                    '</select>' );
